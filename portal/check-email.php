    ...
    <div class="flex items-center justify-center grow bg-center bg-no-repeat page-bg">
        <div class="card max-w-[440px] w-full">
            ...
            <div id="flash-message-container" class="mx-4 mt-4">
                ...
                if ($flash):
                    $message_class = ($flash['type'] === 'success') ? 'success-message' : 'error-message';
                    $icon_color = ($flash['type'] === 'success') ? 'text-green-500' : 'text-red-500';
                ?>
                    <div class="<?php echo $message_class; ?> p-4 mb-4 rounded shadow-md" role="alert">
                        <?php if ($flash['type'] === 'success'): ?>
                            <?php echo $flash['content']; // Render HTML directly ?>
                        <?php else: ?>
                            <div class="flex items-center">
                                ...
                                <div class="ml-3">
                                    <p class="text-sm font-medium">
                                        <span class="lang-en"><?php echo htmlspecialchars($flash['content']); ?></span>
                                        <span class="lang-ar <?php echo $current_lang === 'en' ? 'hidden' : ''; ?>">
                                            <?php echo htmlspecialchars(isset($translations['ar'][$flash['content']]) ? $translations['ar'][$flash['content']] : $flash['content']); ?>
                                        </span>
                                    </p>
                                </div>
                            </div>
