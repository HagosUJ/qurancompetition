<?php
// filepath: /Applications/XAMPP/xamppfiles/htdocs/musabaqa/includes/nigeria_data.php

// Source: May need updating/verification from a reliable source
$nigeria_geo_data = [
...
function get_nigerian_states() {
    global $nigeria_geo_data;
    return array_keys($nigeria_geo_data);
}

function get_lgas_for_state($state) {
    global $nigeria_geo_data;
    return $nigeria_geo_data[$state] ?? [];
}

// Function to get all data as JSON for JavaScript
function get_nigeria_geo_data_json() {
    global $nigeria_geo_data;
    return json_encode($nigeria_geo_data);
}
?>